        ...
        <div className=' h-auto mt-4 bg-gray-800 rounded-lg shadow p-4 flex flex-col text-white relative gap-4 bg-opacity-0'>
          <div className='flex'>
            <button
              ...
              className={`text-white py-2 px-4 border-b-2 border-transparent focus:border-innovest hover:border-innovest ${activeTab === 'nft' ? 'border-innovest' : ''
                }`}
            >
              Drops
            </button>
            <button
              ...
              className={`text-white py-2 px-4 border-b-2 border-transparent focus:border-innovest hover:border-innovest ${activeTab === 'investor' ? 'border-innovest' : ''
                }`}
            >
              Leaderboard
            </button>
